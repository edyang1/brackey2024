label s_a1_golem:
    ...
    play ambient "a_town.mp3" loop fadein 2.0
    ...
    iol "Hey, I've never seen you before. Who are you?"
    ...
    menu:
        "Explain how Stavros pointed you in this direction.":
            ...
            show iol hap at nod
            iol "Oh, the old knight! He's a good man, I'm glad he sent you."

        "Explain that you stumbled upon this place by accident.":
            show iol sup at tilt_right
            "The figure tilts its head, its eyes narrowing slightly as if considering your words."
            show iol neu at subtle_breathe
            iol "Accident? That's strange. This place isn't easy to find by chance."

    "You look cold, though. Come with me!"

    show iol neu at step_forward
    ...
    iol "Here. The old man always said when you're cold, you should eat and drink something warm."

    show iol sup at lean_in
    ...
    menu:
        "It's good, just needs some more adjustments.":
            ...
            iol "Really? I'm so happy! I try cooking, but I can't taste the food and I'm always alone, so I never know if it's any good."
        ...
        "It's... It's food, at least.":
            show iol sad at look_down
            "You notice the figure's expression subtly fall, though you can't understand how."
            iol "I'm sorry. I try cooking, but I can't taste the food and I'm always alone, so I never know if it's any good."

    show iol neu at subtle_breathe
    iol "But enough about that. What were you doing before? I could sense you were in a bad situation."
...
label a1_golem_conversation_menu1:
    menu:
        ...
        "Explain how you have little memories of what led you here." if not golem_memory_convo:
            ...
            iol "I get it... you're like me, huh? I can't remember much from my past either."
            show iol sad at look_down
            "For a brief moment, it seems to sag, as though something unseen weighs on it."
            iol "To be honest, I can't remember almost anything from before a year ago."
            iol "Maybe... maybe there's a connection between your case and mine?"
            show iol neu at subtle_breathe
            "It raises its gaze to the ceiling, thoughtfully stroking its chin."
            iol "I'll have to look through some of the old man's notes. He might've written something relevant."
            "It pauses, studying you intently from head to toe, as if measuring something."
            iol "But... you're not a golem, are you? So, I'm not sure if it's exactly the same issue. Oh!"
            show iol hap at lean_in
            "It suddenly stretches out its hand toward you, eyes bright with realization."
            iol "My name is Iolkos. The old man told me that's what I should say when introducing myself."
            jump a1_golem_conversation_menu1
        ...
        "Ask why it's alone in this building. It doesn't seem a great place to be." if not golem_alone_convo:
            ...
            show iol neu at tilt_left
            "It tilts its head as though trying to raise an eyebrow—if it even had one, you reckon."
            iol "What do you mean? This is my home. I like it here! It's full of books and strange little things to play with."
            iol "Plus, the old man said I should stay here for now."
            show iol neu at subtle_breathe
            "It lifts its arms and shrugs, a gesture that seems oddly casual for something so mechanical."
            iol "Besides, I can't really leave... I mean, I *literally* can't."
            show iol sup at look_down
            ...
            iol "These little things are great for doing all sorts of tasks, but they've got one drawback—they won't let me out."
            iol "Not through the windows, and definitely not through the door. Trust me, I've tried."
            show iol neu at step_back
            iol "They always get tangled in the frame. Frustrating, right?"
            jump a1_golem_conversation_menu1
        ...
        "Inquire more about the old man it mentioned." if not golem_oldman_convo:
            ...
            show iol neu at nod
            iol "He's the one who told me what to do here. He's also the one who collected all these books you see."
            ...
            show iol neu at subtle_breathe
            iol "He was a person of great knowledge—he read all these books and even more!"
            iol "He's written down a lot of what he did, and where he went, in this book here."
            show iol sup at tilt_right
            "Its eyes narrow slightly, forming curious, diagonal shapes as it mutters to itself."
            iol "Diary? Is that what it's called?"
            show iol hap at nod
            "It nods, seemingly satisfied with the word."
            iol "In his diary, he says he bought this inn to have somewhere quiet to study... important things."
            iol "I know because he told me. Well, sort of."
            show iol sad at look_down
            "The golem's voice lowers slightly, its tone more somber."
            iol "He made me, but he hasn't come back since I woke up... a year ago."
            ...
            iol "See? He says he made me, and that I'm supposed to do something for him."
            show iol neu at nod
            iol "I just... need to figure out what."
            jump a1_golem_conversation_menu1

        "Ask about how it managed to take you here." if not golem_move_convo:
            $ golem_move_convo = True

            show iol neu at tilt_right
            iol "Oh, that? It's something I can do pretty easily with these."
            ...
            show iol neu at subtle_breathe
            iol "I can use them to move things or change how they behave—inside this place and even outside."
            iol "But... when I try to reach beyond the inn, it gets much harder."
            show iol sup at lean_in
            ...
            iol "They're useful for a lot of things, but... they lack finesse sometimes."
            show iol sad at look_down
            iol "And they definitely won't let me leave."
            "For just a moment, a shadow of sadness flickers across its dark eyes before disappearing, as fleeting as it came."
            show iol neu at nod
            iol "But it's fine! The old man gave them to me, so I'm sure there's something I haven't figured out yet."
            iol "Maybe there's something in one of the books he left behind."
            jump a1_golem_conversation_menu1
...
label a1_golem_conversation_menu2:
    menu:
        "State that maybe your memory problem may be caused by some disease you caught on the way here." if not golem_disease_convo:
            ...
            show iol neu at subtle_breathe
            iol "Well, it could be. It seems that humans and other similar species can contract diseases from all sorts of sources—water, air, food, plants..."
            ...
            show iol sup at tilt_right
            iol "Hmm, I'm guessing you haven't consumed any fermented basilisk eyes lately, so we can probably rule out ophthalmic spiral spikes."
            show iol neu at subtle_breathe
            iol "But it could be some other kind of disease entirely—maybe even one that hasn't been discovered yet."
            ...
            show iol hap at lean_in
            iol "I just remembered something! The old man once lent some books to the head physician at the local hospice."
            iol "He might know what's wrong with you—it's definitely worth checking out!"
            jump a1_golem_conversation_menu2
        ...
        "Ask what exactly it means by 'fun'." if not golem_fun_convo:
            ...
            iol "There's plenty of fun to be had here, you know!"
            show iol neu at tilt_left
            iol "There are five hundred ninety-four books on thirty-two different subjects,"
            iol "and I've only read a third of them—some are even in languages I don't know yet!"
            iol "There's so much to discover,"
            iol "like how to make broth using horse hooves or how long sparrow beaks are if they hatch in autumn when it's cold!"
            ...
            show iol neu at nod
            iol "I'm teaching myself how to cook for when the old man comes back."
            iol "I've read half a dozen cookbooks and have been practicing for a month."
            iol "I also try to fix things."
            show iol neu at subtle_breathe
            ...
            show iol hap at lean_in
            iol "Oh, and sometimes I manage to watch people while they travel and even... sort of talk to them."
            "Noticing your skepticism, the golem clarifies."
            show iol neu at tilt_right
            iol "Just like I sensed you were in trouble, I can feel people nearby when they aren't too far from the inn."
            iol "I can shift things around, move things between places."
            show iol neu at step_forward
            iol "That's how I get the ingredients to practice my cooking."
            "It raises a hand, almost in defense."
            show iol sup at tilt_left
            iol "And of course, I leave money in place of the goods I take."
            iol "The old man said that's how people trade, right?"
            show iol neu at subtle_breathe
        ...
        "Question it about where the old man may be now." if not golem_oldman_convo2:
            ...
            iol "I... I don't know."
            iol "I haven't seen him since I woke up."
            iol "Maybe he went on one of the trips he wrote about in his diary."
            iol "But... he didn't leave any instructions."
            "The sadness in its voice seems to dim the hopeful energy you've seen up to now."
            show iol neu at subtle_breathe
            iol "I know I'm supposed to wait for him, but I also feel like I need to do what he told me—explore both the inside and outside of the inn."
            show iol sad at look_down
            "Its gaze falls, and for the first time, you see the weight of its uncertainty fully."
            iol "I don't know what to do."
            iol "I'd love to know when he's coming back... but I also want to find a way to walk outside with my own feet, not just through these threads."
            jump a1_golem_conversation_menu2
        ...
        "Ask for more information about the strange threads." if not golem_threads_convo:
            ...
            show iol neu at nod
            iol "I'm sure they work with my body because I can only use them to interact with things if a part of me is touching them."
            "You recall the golem always keeping its feet on the ground while manipulating the cookware with its threads."
            show iol neu at step_forward
            iol "But, I can also make them work outside the inn if I'm touching certain materials—like hardwood, slatestone, or metals."
            iol "That's how I bring in the things I buy from the outside."
            show iol sup at look_away
            "It glances up at the ceiling, then down at its hands, and finally back at you, a flicker of doubt crossing its face."
            iol "You know, sometimes I wonder if they're meant to keep me in here."
            show iol neu at subtle_breathe
            iol "But... that wouldn't make sense, right?"
            iol "The old man said that one day I'd have to go outside and see the world."
            jump a1_golem_conversation_menu2
...
label a1_golem_conversation_menu3:
    menu:
        ...
        "Ask how it can be certain that the old man will come back." if not golem_oldman_convo3:
            ...
            show iol sup at subtle_breathe
            "The golem's expression shifts from bubbling excitement to meek uncertainty as you pose your question."

            iol "I... I am not. I honestly have no clue."
            show iol sad at look_down
            iol "The Illyrian left so many things written down for me, but not everything was meant for me specifically."
            iol "Sometimes he mentions other names—names that sound like mine, but aren't."
            iol "They look like other golems, but I can't find any trace of them, and I've searched this inn inch by inch."

            "It pauses, the thought seemingly weighing on it."
            show iol sup at tilt_right
            iol "Maybe they were my siblings? Is that what they'd be called?"

            show iol neu at look_away
            ...
            show iol sad at subtle_breathe
            ...
            iol "I know there's much the old man hasn't told me yet, but I *have* to figure it all out before he comes back."
            iol "I need to understand how the world works—how people live."
            iol "That's my purpose. I'm sure of it."

            show iol hap at lean_in
            "Its voice rises with renewed energy, the earlier hesitation all but gone."

            iol "And I *know* he'll come back. I can feel it deep inside me."
            iol "When he does, I'll have done everything he expected of me, and we'll have dinner together, just like you and I!"
...
label a1_golem1:
    ...
    show iol neu at subtle_breathe
    iol "Ah, you're awake! Morning. I made some soup. Not the best for breakfast, maybe, but it's all I've got right now."
    "Iolkos sets a steaming bowl in front of you, the aroma of simple broth filling the air."

    show iol neu at nod
    iol "Eat up. The hospice is west, past the village. You'll find it soon enough."
    ...
    show iol sad at look_down
    iol "You know… if you ever come back this way, I could use the company. It's… pretty quiet here most of the time."

    show iol sup at subtle_breathe
    "Its voice softens, just for a moment, before it resumes its usual bright tone."

    show iol neu at nod
    iol "But, of course, no pressure! Just thought I'd mention it."
    
    iol "Well... I guess this is goodbye for now, huh?"

    show iol sad at look_away
    "Iolkos' eyes gleam softly, the ever-present threads swirling around it as if hesitant to let go of the moment."

    show iol hap at lean_in
    iol "I really hope you find what you're looking for out there. I'll keep the place tidy, just in case you come back."

    "It gives a small, awkward wave, the threads fluttering slightly in response."

    show iol neu at subtle_breathe
    iol "Remember, the world's a big place... but I think you'll do just fine."
    iol "I'll be here, learning, waiting, and maybe... maybe one day I'll step outside too."

    show iol sad at look_down
    "For a brief moment, the golem's expression shifts, its eyes reflecting something deeper—a flicker of hope and longing."

    show iol hap at nod
    iol "Take care out there. And if you ever need a strange little inn with a strange little golem, you know where to find me!"
